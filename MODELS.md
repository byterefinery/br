...
~/llama.cpp/build/bin/llama-server \
    -hf 'LiquidAI/LFM2.5-8B-A1B-GGUF:Q5_K_M' \
    --alias 'LiquidAI/LFM2.5-8B-A1B' \
    -ngl -1 \
    -np 1 \
    --temp 0.2 --top-k 80 --repeat-penalty 1.05 -c 128000 -fa on \
    --spec-default \
    --reasoning on \
...
Current version `G1h` of the model has issue with looping, so we await new `G1i` version of model.
